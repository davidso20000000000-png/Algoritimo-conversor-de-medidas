...
Um algoritmo simples em Python que realiza conversões básicas entre unidades de comprimento.
...
Escolhe uma das opções de conversão disponíveis.
...
Se quiser que isso deixe de ser um código "nota média", você deveria:

Permitir números decimais (float)
Validar entradas do usuário (evitar crash)
Criar um loop para repetir o programa automaticamente
Melhorar a interface (menus mais claros ou até GUI)
Adicionar mais unidades (milhas, polegadas, etc.)
💻 Exemplo de uso
Qual o valor? 5
